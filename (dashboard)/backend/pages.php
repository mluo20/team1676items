                    ...
                    <?php if ($pages['count'] > 0)  {?>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>$page->label</td>
                                <td>
                                    <a href="edit.php?page=$page->id" class="btn btn-primary btn-xs">Edit</a>
                                    <a href="../dashboard.php?page=$page->id" class="btn btn-primary btn-xs">View</a>
                                    <a href="edit.php?page=$page->id&action=delete" class="btn btn-primary btn-xs">Delete</a>
                                </td>
                            </tr>
_END;
                            }
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit.php?page=$page->id" class="btn btn-primary btn-xs">Edit</a>
                                    <a href="edit.php?page=$page->id&action=delete" class="btn btn-primary btn-xs">Delete</a>
                                    <a href="../dashboard.php?page=$page->id&preview=true" class="btn btn-primary btn-xs">View</a>
                                </td>
                            </tr>
_END;
                            }
