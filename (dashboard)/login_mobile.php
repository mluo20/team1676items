...
<head>
  ...
  <script type="text/javascript">
    if (screen.width >= 720) {
        window.location = "http://dashboard.team1676.com/login.php";
    }
  </script>
...
<body style="background-color: black;">
  ...
  <div id="page">
    ...
    <table class="loginTable">
      ...
      <form action="login_mobile.php?login" method="post" class="cbp-mc-form" autocomplete="off">
      ...
      <form action="https://goo.gl/forms/EAW51HJu8Lz4QVdA2" method="get" class="cbp-mc-form">
          <tr>
            <td style="padding-top: 40px;">&nbsp;&nbsp;&nbsp;<input style="cursor: pointer;" class="buttonb" type="submit" value=
      ...
      <td valign="top">
      <br><br><h3 align="center" style="margin-top: 60px;">Register</h3>
      <form action="login_mobile.php?new" method="post" class="cbp-mc-form" autocomplete="off">
      <div class="cbp-mc-column">
          <tr>
  ...
  <center>
   ...
   <?php } else{ ?>
     ...
     <center>
      <form action="login_mobile.php?ci" method="post">
        <div id="frm"></div><?php if($_SESSION['uid'] == 0){
                                  echo "<h3 align='center'>Not Logged In.</h3>";
                                }
                                else{ ?><br><br><input class="butonb clock-in" style="width:62.5%;font-size:24pt;" type='submit' value='Clock In'>
      ...
      <center>
        <form action="login_mobile.php?co" method="post">
          <div id="frm2">
            <p></p>
          </div>
          <div class='question'>
          ...
          <textarea width="100%" height="15%" cols='50' name='what' required="" rows='10'></textarea><br><br><br><br>
          <input type='submit' class="butonb clock-in" style="width:62.5%;font-size:24pt;" value='Clock Out'>
            <form action="https://goo.gl/forms/EAW51HJu8Lz4QVdA2" method="get" class="cbp-mc-form">
          <tr>
            <td style="padding-top: 40px;">&nbsp;&nbsp;&nbsp;<input style="cursor: pointer;" class="buttonb" type="submit" value=
            "Forgot to Clock-In?"></td>
