            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="admin.php">Home</a> / <i class="fa fa-pencil"></i> Post Email
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <form action="" method="POST" class="dirty-check">
                    ...
                    <div class="form-group">
                        <input type="text" name="title" class="form-control input-lg" placeholder="Enter Subject and Date (Ex. Pioneer Reminders - 1/1/18)" required="">
                    </div>
                    <div id="content">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <label for="label">Menu Label (Optional): </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8 col-sm-8" style="display:none;">
                                <b>Show on Menu:</b><br>
