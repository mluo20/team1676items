...
if (!isset($_GET['form'])) header("Location: forms.php");
if (empty($_GET['form'])) header("Location: forms.php");
...
$editing = Form::getById($_GET['form']);
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['publish'])) {
        ...
        $editing->showing = 1;
        $editing->update();
        header("Location: ../index?form=$editing->id");
    }
    if (isset($_POST['save'])) {
        $editing->storeFormValues($_POST);
        $editing->update();
            ...
            <div class="container-fluid">
                ...
                <form action="" method="POST" class="dirty-check">
                    ...
                    <div class="col-sm-3">
                        ...
                        <a href="../index.php?form=<?php echo $editing->id."&preview=true"; ?>" target="_blank">Preview</a>
                        <div class="form-group">
                        <br>
