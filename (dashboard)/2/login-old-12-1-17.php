...
<!-- Body -->
<body style="background-color: black;" id="bod">
  ...
  <div class="item"><br>
    ...
    <div id="main">
      ...
      <form id="login" action="login.php?login" method="post" class="cbp-mc-form" autocomplete="off">
    ...
    <!-- New Sign-In Form -->
    <div class="item-overlay bottom" id="showButton"><br><br><br>
      <div class="center-me" id="center-me"><div id="bigger">
        <h1 id="welcome">Welcome!</h1>
        <p id="welcome-message" style="margin-bottom: 0px;">Please click &quot;Sign in&quot; below to continue.</p>
        <a onclick="justSignOut()" href="login.php"><p id="welcome-message2"></p></a><br>
        <div class="g-signin2" id="goog" data-onsuccess="onSignIn" data-theme="dark"></div></div><br>
        <img id="profile">
        <div id="action-buttons" style="display: none;"><br><br>
          <input class="button cbp-mc-submit" type="submit" form="login" id="login" value="Login"><br><br>
          <input class="button cbp-mc-submit" type="submit" form="register" id="register" value="Register">
        </div>
      </div>
    </div>
    </div>
  ...
  <div class="google-auto" id="hideButton">
    <p>Change View:</p>
    <button onclick="signOut();" style="color: #000;">&nbsp;&nbsp;&nbsp;Old Sign-In&nbsp;&nbsp;&nbsp;</button>
  </div>
  <div class="google-auto" id="hideButton2" style="display: none;">
    <p>Change View:</p>
    <button onclick="viewNew();" style="color: #000;">&nbsp;&nbsp;&nbsp;New Sign-In&nbsp;&nbsp;&nbsp;</button>
  </div>
  <!-- /Toggle View Switches -->
      

  <!-- JavaScript and Stuff -->
  <script src="../2/js/signin.js"></script>
  <!-- /JavaScript and Stuff -->
